 ...
 * @return Matrix 
 */
static Matrix generateSmallRotation() {

    double rotX = randomdouble() * .1 * M_PI;
    double rotY = randomdouble() * .1 * M_PI;
    double rotZ = randomdouble() * .1 * M_PI;
...
/**
 * @brief takes min of two doubles
 * 
 */
...
/**
 * @brief takes max of two doubles
 * 
 */
